...
APP_TITLE	:= 3D20
APP_DESCRIPTION	:= d20 Dice System
APP_AUTHOR	:= goodiesohhi
...
@C:\Users\Alex.GOODIESOHHI\AppData\Local\Programs\Python\Python36-32\python.exe C:\libsf2d\aemstro_as.py $< ../$(notdir $<).shbin)
	@echo $(notdir $<)
